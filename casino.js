...
const promoCodes = {
    ...
    "ADMINZ3A9T1K8M4QENFBEWJKKSDAN3WW3": 20000000,
    "ADMINZ3A9T1K8M4QENFBEWJKKSDAN4WW4": 20000000,
    "ADMINZ3A9T1K8M4QENFBEWJKKSDAN5WW5": 20000000
};
...
document.getElementById('btn-crash-start').addEventListener('click', () => {
    ...
    crashInterval = setInterval(() => {
        let step = 0.02;
        if (crashMult >= 10) step = 0.5;
        else if (crashMult >= 5) step = 0.2;
        ...
        if (crashMult >= crashTarget) {
            ...
            document.getElementById('crash-multiplier').innerText = crashTarget.toFixed(2) + 'x';
