// --- LÖSCH-BEFEHL VOM LAUNCHER ABFANGEN ---
...
// --- ÜBERSETZUNGEN (20 SPRACHEN) ---
const translations = {
    de: { bestScore: "Bester Score:", controls: "Steuerung:<br>Leertaste / Klick / Touch", btnStart: "Spiel Starten", btnSettings: "Einstellungen", btnCredits: "Credits", gameOver: "Game Over!", scoreLabel: "Score:", bestLabel: "Best:", btnRestart: "Nochmal", btnMenu: "Hauptmenü", modalSettings: "Einstellungen", labelParticles: "Partikel-Effekte:", labelDifficulty: "Schwierigkeit:", diffEasy: "Einfach", diffNormal: "Normal", diffHard: "Schwer", diffCustom: "Custom", lblGrav: "Schwerkraft:", lblJump: "Sprung:", lblGap: "Lücke:", lblSpd: "Tempo:", lblSpawn: "Spawn Rate:", lblPrev: "Vorschau:", labelLanguage: "Sprache:", btnClose: "Schließen", modalCredits: "Credits", creditsDesc: "Ein ultimatives Flappy Bird Erlebnis." },
    en: { bestScore: "Best Score:", controls: "Controls:<br>Space / Click / Touch", btnStart: "Start Game", btnSettings: "Settings", btnCredits: "Credits", gameOver: "Game Over!", scoreLabel: "Score:", bestLabel: "Best:", btnRestart: "Restart", btnMenu: "Main Menu", modalSettings: "Settings", labelParticles: "Particles:", labelDifficulty: "Difficulty:", diffEasy: "Easy", diffNormal: "Normal", diffHard: "Hard", diffCustom: "Custom", lblGrav: "Gravity:", lblJump: "Jump:", lblGap: "Gap:", lblSpd: "Speed:", lblSpawn: "Spawn Rate:", lblPrev: "Preview:", labelLanguage: "Language:", btnClose: "Close", modalCredits: "Credits", creditsDesc: "An ultimate Flappy Bird experience." },
    es: { bestScore: "Mejor Puntuación:", controls: "Controles:<br>Espacio / Clic / Tocar", btnStart: "Iniciar Juego", btnSettings: "Ajustes", btnCredits: "Créditos", gameOver: "¡Juego Terminado!", scoreLabel: "Puntos:", bestLabel: "Mejor:", btnRestart: "Reiniciar", btnMenu: "Menú Principal", modalSettings: "Ajustes", labelParticles: "Partículas:", labelDifficulty: "Dificultad:", diffEasy: "Fácil", diffNormal: "Normal", diffHard: "Difícil", diffCustom: "Personalizado", lblGrav: "Gravedad:", lblJump: "Salto:", lblGap: "Espacio:", lblSpd: "Velocidad:", lblSpawn: "Aparición:", lblPrev: "Vista previa:", labelLanguage: "Idioma:", btnClose: "Cerrar", modalCredits: "Créditos", creditsDesc: "Una experiencia definitiva de Flappy Bird." },
    fr: { bestScore: "Meilleur Score:", controls: "Contrôles:<br>Espace / Clic / Toucher", btnStart: "Démarrer", btnSettings: "Paramètres", btnCredits: "Crédits", gameOver: "Fin du Jeu!", scoreLabel: "Score:", bestLabel: "Max:", btnRestart: "Rejouer", btnMenu: "Menu Principal", modalSettings: "Paramètres", labelParticles: "Particules:", labelDifficulty: "Difficulté:", diffEasy: "Facile", diffNormal: "Normal", diffHard: "Difficile", diffCustom: "Personnalisé", lblGrav: "Gravité:", lblJump: "Saut:", lblGap: "Écart:", lblSpd: "Vitesse:", lblSpawn: "Apparition:", lblPrev: "Aperçu:", labelLanguage: "Langue:", btnClose: "Fermer", modalCredits: "Crédits", creditsDesc: "Une expérience Flappy Bird ultime." },
    it: { bestScore: "Miglior Punteggio:", controls: "Controlli:<br>Spazio / Clic / Tocco", btnStart: "Inizia Gioco", btnSettings: "Impostazioni", btnCredits: "Crediti", gameOver: "Fine Gioco!", scoreLabel: "Punti:", bestLabel: "Miglior:", btnRestart: "Riavvia", btnMenu: "Menu Principale", modalSettings: "Impostazioni", labelParticles: "Particelle:", labelDifficulty: "Difficoltà:", diffEasy: "Facile", diffNormal: "Normale", diffHard: "Difficile", diffCustom: "Personalizzato", lblGrav: "Gravità:", lblJump: "Salto:", lblGap: "Spazio:", lblSpd: "Velocità:", lblSpawn: "Generazione:", lblPrev: "Anteprima:", labelLanguage: "Lingua:", btnClose: "Chiudi", modalCredits: "Crediti", creditsDesc: "Un'esperienza Flappy Bird definitiva." },
    pt: { bestScore: "Melhor Pontuação:", controls: "Controles:<br>Espaço / Clique / Toque", btnStart: "Iniciar Jogo", btnSettings: "Configurações", btnCredits: "Créditos", gameOver: "Fim de Jogo!", scoreLabel: "Pontos:", bestLabel: "Melhor:", btnRestart: "Reiniciar", btnMenu: "Menu Principal", modalSettings: "Configurações", labelParticles: "Partículas:", labelDifficulty: "Dificuldade:", diffEasy: "Fácil", diffNormal: "Normal", diffHard: "Difícil", diffCustom: "Personalizado", lblGrav: "Gravidade:", lblJump: "Pulo:", lblGap: "Espaço:", lblSpd: "Velocidade:", lblSpawn: "Geração:", lblPrev: "Pré-visualização:", labelLanguage: "Idioma:", btnClose: "Fechar", modalCredits: "Créditos", creditsDesc: "Uma experiência definitiva de Flappy Bird." },
    nl: { bestScore: "Beste Score:", controls: "Besturing:<br>Spatie / Klik / Touch", btnStart: "Start Spel", btnSettings: "Instellingen", btnCredits: "Credits", gameOver: "Spel Voorbij!", scoreLabel: "Score:", bestLabel: "Beste:", btnRestart: "Opnieuw", btnMenu: "Hoofdmenu", modalSettings: "Instellingen", labelParticles: "Deeltjes:", labelDifficulty: "Moeilijkheid:", diffEasy: "Makkelijk", diffNormal: "Normaal", diffHard: "Moeilijk", diffCustom: "Aangepast", lblGrav: "Zwaartekracht:", lblJump: "Sprong:", lblGap: "Ruimte:", lblSpd: "Snelheid:", lblSpawn: "Generatie:", lblPrev: "Voorbeeld:", labelLanguage: "Taal:", btnClose: "Sluiten", modalCredits: "Credits", creditsDesc: "Een ultieme Flappy Bird ervaring." },
    pl: { bestScore: "Najlepszy Wynik:", controls: "Sterowanie:<br>Spacja / Klik / Dotyk", btnStart: "Start Gry", btnSettings: "Ustawienia", btnCredits: "Twórcy", gameOver: "Koniec Gry!", scoreLabel: "Wynik:", bestLabel: "Najlepszy:", btnRestart: "Restart", btnMenu: "Menu Główne", modalSettings: "Ustawienia", labelParticles: "Cząsteczki:", labelDifficulty: "Trudność:", diffEasy: "Łatwy", diffNormal: "Normalny", diffHard: "Trudny", diffCustom: "Własny", lblGrav: "Grawitacja:", lblJump: "Skok:", lblGap: "Przerwa:", lblSpd: "Prędkość:", lblSpawn: "Częstotliwość:", lblPrev: "Podgląd:", labelLanguage: "Język:", btnClose: "Zamknij", modalCredits: "Twórcy", creditsDesc: "Najlepsze doświadczenie Flappy Bird." },
    ru: { bestScore: "Лучший Счет:", controls: "Управление:<br>Пробел / Клик / Касание", btnStart: "Начать Игру", btnSettings: "Настройки", btnCredits: "Создатели", gameOver: "Игра Окончена!", scoreLabel: "Счет:", bestLabel: "Лучший:", btnRestart: "Заново", btnMenu: "Главное Меню", modalSettings: "Настройки", labelParticles: "Частицы:", labelDifficulty: "Сложность:", diffEasy: "Легко", diffNormal: "Нормально", diffHard: "Сложно", diffCustom: "Свой", lblGrav: "Гравитация:", lblJump: "Прыжок:", lblGap: "Зазор:", lblSpd: "Скорость:", lblSpawn: "Появление:", lblPrev: "Предпросмотр:", labelLanguage: "Язык:", btnClose: "Закрыть", modalCredits: "Создатели", creditsDesc: "Идеальный опыт Flappy Bird." },
    ja: { bestScore: "ベストスコア:", controls: "操作:<br>スペース / クリック / タッチ", btnStart: "ゲーム開始", btnSettings: "設定", btnCredits: "クレジット", gameOver: "ゲームオーバー!", scoreLabel: "スコア:", bestLabel: "ベスト:", btnRestart: "リスタート", btnMenu: "メインメニュー", modalSettings: "設定", labelParticles: "パーティクル:", labelDifficulty: "難易度:", diffEasy: "簡単", diffNormal: "普通", diffHard: "難しい", diffCustom: "カスタム", lblGrav: "重力:", lblJump: "ジャンプ:", lblGap: "隙間:", lblSpd: "速度:", lblSpawn: "出現率:", lblPrev: "プレビュー:", labelLanguage: "言語:", btnClose: "閉じる", modalCredits: "クレジット", creditsDesc: "究極のFlappy Bird体験。" },
    zh: { bestScore: "最高分:", controls: "控制:<br>空格 / 点击 / 触摸", btnStart: "开始游戏", btnSettings: "设置", btnCredits: "关于", gameOver: "游戏结束!", scoreLabel: "分数:", bestLabel: "最高:", btnRestart: "重新开始", btnMenu: "主菜单", modalSettings: "设置", labelParticles: "粒子:", labelDifficulty: "难度:", diffEasy: "简单", diffNormal: "普通", diffHard: "困难", diffCustom: "自定义", lblGrav: "重力:", lblJump: "跳跃:", lblGap: "间距:", lblSpd: "速度:", lblSpawn: "生成率:", lblPrev: "预览:", labelLanguage: "语言:", btnClose: "关闭", modalCredits: "关于", creditsDesc: "终极Flappy Bird体验。" },
    ko: { bestScore: "최고 점수:", controls: "조작:<br>스페이스 / 클릭 / 터치", btnStart: "게임 시작", btnSettings: "설정", btnCredits: "크레딧", gameOver: "게임 오버!", scoreLabel: "점수:", bestLabel: "최고:", btnRestart: "다시 시작", btnMenu: "메인 메뉴", modalSettings: "설정", labelParticles: "입자:", labelDifficulty: "난이도:", diffEasy: "쉬움", diffNormal: "보통", diffHard: "어려움", diffCustom: "커스텀", lblGrav: "중력:", lblJump: "점프:", lblGap: "간격:", lblSpd: "속도:", lblSpawn: "생성률:", lblPrev: "미리보기:", labelLanguage: "언어:", btnClose: "닫기", modalCredits: "크레딧", creditsDesc: "최고의 Flappy Bird 경험." },
    ar: { bestScore: "أفضل نتيجة:", controls: "التحكم:<br>مسافة / نقر / لمس", btnStart: "ابدأ اللعبة", btnSettings: "الإعدادات", btnCredits: "الاعتمادات", gameOver: "انتهت اللعبة!", scoreLabel: "النتيجة:", bestLabel: "الأفضل:", btnRestart: "إعادة المحاولة", btnMenu: "القائمة الرئيسية", modalSettings: "الإعدادات", labelParticles: "تأثيرات:", labelDifficulty: "الصعوبة:", diffEasy: "سهل", diffNormal: "عادي", diffHard: "صعب", diffCustom: "مخصص", lblGrav: "جاذبية:", lblJump: "قفز:", lblGap: "فجوة:", lblSpd: "سرعة:", lblSpawn: "معدل الظهور:", lblPrev: "معاينة:", labelLanguage: "اللغة:", btnClose: "إغلاق", modalCredits: "الاعتمادات", creditsDesc: "تجربة Flappy Bird المطلقة." },
    hi: { bestScore: "सर्वश्रेष्ठ स्कोर:", controls: "नियंत्रण:<br>स्पेस / क्लिक / टच", btnStart: "खेल शुरू करें", btnSettings: "सेटिंग्स", btnCredits: "क्रेडिट्स", gameOver: "गेम ओवर!", scoreLabel: "स्कोर:", bestLabel: "बेस्ट:", btnRestart: "पुनः आरंभ करें", btnMenu: "मुख्य मेनू", modalSettings: "सेटिंग्स", labelParticles: "कण:", labelDifficulty: "कठिनाई:", diffEasy: "आसान", diffNormal: "सामान्य", diffHard: "कठिन", diffCustom: "कस्टम", lblGrav: "गुरुत्वाकर्षण:", lblJump: "कूद:", lblGap: "अंतर:", lblSpd: "गति:", lblSpawn: "स्पॉन दर:", lblPrev: "पूर्वावलोकन:", labelLanguage: "भाषा:", btnClose: "बंद करें", modalCredits: "क्रेडिट्स", creditsDesc: "एक परम Flappy Bird अनुभव।" },
    tr: { bestScore: "En İyi Skor:", controls: "Kontroller:<br>Boşluk / Tıklama / Dokunma", btnStart: "Oyuna Başla", btnSettings: "Ayarlar", btnCredits: "Hakkında", gameOver: "Oyun Bitti!", scoreLabel: "Skor:", bestLabel: "En İyi:", btnRestart: "Tekrar", btnMenu: "Ana Menü", modalSettings: "Ayarlar", labelParticles: "Parçacıklar:", labelDifficulty: "Zorluk:", diffEasy: "Kolay", diffNormal: "Normal", diffHard: "Zor", diffCustom: "Özel", lblGrav: "Yerçekimi:", lblJump: "Zıplama:", lblGap: "Boşluk:", lblSpd: "Hız:", lblSpawn: "Oluşum:", lblPrev: "Önizleme:", labelLanguage: "Dil:", btnClose: "Kapat", modalCredits: "Hakkında", creditsDesc: "Nihai Flappy Bird deneyimi." },
    sv: { bestScore: "Bästa Poäng:", controls: "Kontroller:<br>Mellanslag / Klick / Touch", btnStart: "Starta Spel", btnSettings: "Inställningar", btnCredits: "Krediter", gameOver: "Spelet är Slut!", scoreLabel: "Poäng:", bestLabel: "Bästa:", btnRestart: "Spela Igen", btnMenu: "Huvudmeny", modalSettings: "Inställningar", labelParticles: "Partiklar:", labelDifficulty: "Svårighet:", diffEasy: "Lätt", diffNormal: "Normal", diffHard: "Svår", diffCustom: "Anpassad", lblGrav: "Gravitation:", lblJump: "Hopp:", lblGap: "Avstånd:", lblSpd: "Hastighet:", lblSpawn: "Skapande:", lblPrev: "Förhandsgranskning:", labelLanguage: "Språk:", btnClose: "Stäng", modalCredits: "Krediter", creditsDesc: "Den ultimata Flappy Bird-upplevelsen." },
    da: { bestScore: "Bedste Score:", controls: "Kontrol:<br>Mellemrum / Klik / Touch", btnStart: "Start Spil", btnSettings: "Indstillinger", btnCredits: "Kreditter", gameOver: "Spillet er Slut!", scoreLabel: "Score:", bestLabel: "Bedste:", btnRestart: "Prøv Igen", btnMenu: "Hovedmenu", modalSettings: "Indstillinger", labelParticles: "Partikler:", labelDifficulty: "Sværhedsgrad:", diffEasy: "Nem", diffNormal: "Normal", diffHard: "Svær", diffCustom: "Egen", lblGrav: "Tyngdekraft:", lblJump: "Hop:", lblGap: "Afstand:", lblSpd: "Hastighet:", lblSpawn: "Spawn:", lblPrev: "Forhåndsvisning:", labelLanguage: "Sprog:", btnClose: "Luk", modalCredits: "Kreditter", creditsDesc: "En ultimativ Flappy Bird oplevelse." },
    fi: { bestScore: "Paras Tulos:", controls: "Ohjaimet:<br>Välilyönti / Klikkaus / Kosketus", btnStart: "Aloita Peli", btnSettings: "Asetukset", btnCredits: "Tekijät", gameOver: "Peli Ohi!", scoreLabel: "Pisteet:", bestLabel: "Paras:", btnRestart: "Uudelleen", btnMenu: "Päävalikko", modalSettings: "Asetukset", labelParticles: "Hiukkaset:", labelDifficulty: "Vaikeus:", diffEasy: "Helppo", diffNormal: "Normaali", diffHard: "Vaikea", diffCustom: "Oma", lblGrav: "Painovoima:", lblJump: "Hyppy:", lblGap: "Väli:", lblSpd: "Nopeus:", lblSpawn: "Syntyminen:", lblPrev: "Esikatselu:", labelLanguage: "Kieli:", btnClose: "Sulje", modalCredits: "Tekijät", creditsDesc: "Lopullinen Flappy Bird -kokemus." },
    el: { bestScore: "Καλύτερο Σκορ:", controls: "Έλεγχοι:<br>Διάστημα / Κλικ / Αφή", btnStart: "Έναρξη", btnSettings: "Ρυθμίσεις", btnCredits: "Συντελεστές", gameOver: "Τέλος Παιχνιδιού!", scoreLabel: "Σκορ:", bestLabel: "Καλύτερο:", btnRestart: "Επανεκκίνηση", btnMenu: "Αρχικό Μενού", modalSettings: "Ρυθμίσεις", labelParticles: "Σωματίδια:", labelDifficulty: "Δυσκολία:", diffEasy: "Εύκολο", diffNormal: "Κανονικό", diffHard: "Δύσκολο", diffCustom: "Προσαρμοσμένο", lblGrav: "Βαρύτητα:", lblJump: "Άλμα:", lblGap: "Κενό:", lblSpd: "Ταχύτητα:", lblSpawn: "Εμφάνιση:", lblPrev: "Προεπισκόπηση:", labelLanguage: "Γλώσσα:", btnClose: "Κλείσιμο", modalCredits: "Συντελεστές", creditsDesc: "Η απόλυτη εμπειρία Flappy Bird." },
    cs: { bestScore: "Nejlepší Skóre:", controls: "Ovládání:<br>Mezerník / Klik / Dotyk", btnStart: "Začít Hru", btnSettings: "Nastavení", btnCredits: "Kredity", gameOver: "Konec Hry!", scoreLabel: "Skóre:", bestLabel: "Nejlepší:", btnRestart: "Znovu", btnMenu: "Hlavní Menu", modalSettings: "Nastavení", labelParticles: "Částice:", labelDifficulty: "Obtížnost:", diffEasy: "Lehká", diffNormal: "Normální", diffHard: "Těžká", diffCustom: "Vlastní", lblGrav: "Gravitace:", lblJump: "Skok:", lblGap: "Mezera:", lblSpd: "Rychlost:", lblSpawn: "Frekvence:", lblPrev: "Náhled:", labelLanguage: "Jazyk:", btnClose: "Zavřít", modalCredits: "Kredity", creditsDesc: "Ultimátní zážitek z Flappy Bird." }
};
...
if (forcedLang) {
    localStorage.setItem('flappyLang', forcedLang);
}

// Custom Settings laden
...
function previewLoop() {
    if (elements.settingsModal.classList.contains('hidden') || currentDiff !== 'custom') {
    ...
    if (pFrames % spawn === 0) {
        pPipes.push({ x: 480, top: Math.random() * (720 - 150 - 60 - gap) + 60 });
    }
...
const bg = {
    ...
    h: 150,
    clouds: [
        { x: 50, y: 100, speed: 0.5, size: 40 },
        { x: 250, y: 180, speed: 0.3, size: 60 },
        { x: 400, y: 80, speed: 0.6, size: 30 },
        { x: 600, y: 250, speed: 0.4, size: 50 }
    ],
    draw() {
    ...
    update() {
        ...
        if (gameState === 'PLAY') { this.x = (this.x - gameSpeed) % 40; }
    }
};
...
function handleInput(e) {
    if (!elements.settingsModal.classList.contains('hidden') || !elements.creditsModal.classList.contains('hidden')) return;
